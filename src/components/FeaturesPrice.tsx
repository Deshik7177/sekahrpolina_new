          ...
          >
            <div className="relative">
              <div className="absolute -inset-2 rounded-3xl pointer-events-none z-0" style={{ boxShadow: '0 0 40px 8px #077eff88' }} />
                <ElectricBorder color="#077eff" borderRadius={28} chaos={0.13} speed={1.2} className="rounded-3xl">
                  <div className="rounded-3xl p-6 md:p-8 border border-white/20 shadow-2xl relative" style={{ background: 'rgba(10, 14, 22, 0.96)', backdropFilter: 'blur(24px)', WebkitBackdropFilter: 'blur(24px)' }}>
                    {/* Overlay to soften neon */}
                    <div className="absolute inset-0 rounded-3xl pointer-events-none" style={{ background: 'rgba(10,14,22,0.7)' }} />
                    <NeonBeamCard>
                      {/* Badge */}
                      <motion.div
                        ...
                        style={{ textShadow: '0 2px 12px #000, 0 0px 2px #077eff' }}
                      >
                      ...
                      <ul className="space-y-3 mb-8">
                        {[
                          ...
                          <li key={item} className="flex items-center gap-2 text-white text-xs md:text-sm font-medium">
                            ...
                            <span style={{ textShadow: '0 2px 8px #000' }}>{item}</span>
                          </li>
                        ))}
                      </ul>
                      ...
                      <motion.button
                        animate={{ boxShadow: [
                          "0px 0px 0px rgba(7,126,255,0)",
                          "0px 0px 20px rgba(7,126,255,0.6)",
                          "0px 0px 0px rgba(7,126,255,0)"
                        ] }}
                        transition={{ repeat: Infinity, duration: 2 }}
                        whileHover={{ scale: 1.04, boxShadow: '0px 0px 32px #077eff' }}
                        ...
                        style={{ background: 'none', border: 'none', textShadow: '0 2px 12px #000' }}
                      >
                        <span className="absolute inset-0 bg-gradient-to-r from-[#077eff] via-[#00cfff] to-[#1e2a78] rounded-xl" />
                        <span className="absolute inset-0 bg-gradient-to-r from-[#00cfff]/60 via-[#077eff]/40 to-[#1e2a78]/60 bg-[length:200%] group-hover:bg-right-center rounded-xl transition-all duration-700 pulse-glow" />
                      ...
                      <p className="text-center text-white/40 text-xs mt-3">
                        <span style={{ textShadow: '0 2px 8px #000' }}>
